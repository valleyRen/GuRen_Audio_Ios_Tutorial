...
-(void) buttonClickDebug:(UIButton *)sender{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            // 更新界面
          //  DebugViewController *userListPage = [[DebugViewController alloc] initWit hRoom:nil  CfgTable:cfgTable LengthOfTable:sizeof(cfgTable)/sizeof(cfgTable[0]) ];
...
-(void) buttonClickEnableAnchorMode:(UIButton *)sender{
    ...
    [rtcMusicCtrl Enable:typeNs|typeAec|typeVad|typeAgc enable:false];
     //rtmp://push.wangsu.valley.ren/live/valley
    int ec = [rtcMusicCtrl StartRtmp:@"rtmp://10.220.10.35:1935/live/aac1" sreamtypes:0x01 bUseServer:false];
    NSLog(@" StartRtmp :%d", ec);
}
...
-(void) buttonClickEnableJoinMicMode:(UIButton *)sender{
    ...
    [rtcMusicCtrl Enable:typeNs|typeVad|typeAgc enable:false];
    [rtcMusicCtrl Enable:typeAec enable:true];
}
